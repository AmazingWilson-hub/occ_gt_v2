...
def parse_args():
    ...
    parser.add_argument(
        ...
        required=False,
        help='specify nuscenes version (v1.0-mini, v1.0-trainval)')
...
def convert2occupy(dataroot, save_path, num_sweeps=10, version='v1.0-trainval'):
...
if __name__ == "__main__":
    args = parse_args()
    convert2occupy(args.dataroot, args.save_path, args.num_sweeps, args.version)
